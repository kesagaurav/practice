...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String url = "jdbc:mysql//gauravmysqldbinstance.crlpgw5u7n0e.ap-south-1.rds.amazonaws.com/3306/player";
			String username = "admin";
			String password = "gaurav123"; // Give your DB username and Password
